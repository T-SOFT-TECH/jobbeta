<script>
	import StudentsHero from '$lib/components/students/StudentsHero.svelte';
...
<svelte:head>
	<title>Students | JobBeta</title>
	<meta
		name="description"
		content="Find your dream job or internship with JobBeta. Free for students and graduates."
	/>
</svelte:head>
